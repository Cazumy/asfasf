...
protected:	// объ€вление элементов данных класса
	...
	static int count_of_Fridge;		// переменна€ отвечающа€ за количество объектов Fridge
...
public:
	...
	Fridge(const Fridge& object) {		// конструктор копировани€
		count_of_Fridge++;
	...
	~Fridge() {		// деструктор
		delete[] model_of_Fridge; //удаление выделенной пам€ти дл€ model;
	}
	...
	void setManufacturer()override;		// установка производител€
	const char* getManufacturer()const override;	// вывод производител€

	void setCapacity(int capacity);		//установка объЄма холодильника
	int getCapacity() const;		// вывод объЄма холодильника
